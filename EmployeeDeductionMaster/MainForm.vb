Public Class MainForm
    ...
    Private Sub UploadCustomerDetailsToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UploadCustomerDetailsToolStripMenuItem1.Click
        Dim vrl As New UploadingCustomerDetailsInDeduction
        vrl.MdiParent = mform
        vrl.Text = vrl.Text & " : Employer Name = " & employername
        vrl.Show()
    End Sub
    ...
    Private Sub UploadSupervisorsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UploadSupervisorsToolStripMenuItem.Click
        Dim vrl As New UploadSalesCustomers
        vrl.MdiParent = mform
        vrl.Show()
    End Sub
    ...
    Private Sub CovidRegisterToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ProductsGroupingToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ProductsGroupingToolStripMenuItem.Click
        Dim vrl As New ProductGrouping
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub GroupProductGroupingToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GroupProductGroupingToolStripMenuItem.Click
        Dim vrl As New EmployerProductGrouping
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub SalesAgentsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SalesAgentsToolStripMenuItem.Click
        Dim vrl As New SalesAgents
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub UploadSchoolToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UploadSchoolToolStripMenuItem.Click
        Dim vrl As New UploadSchools
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub CaptureFileNumbersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CaptureFileNumbersToolStripMenuItem.Click
        Dim vrl As New FIllingDocuments
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub CustomerFilesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CustomerFilesToolStripMenuItem.Click
        Dim vrl As New CustomerFiles
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub UploadDepartmentsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UploadDepartmentsToolStripMenuItem.Click
        Dim vrl As New UploadDepartments
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub CustomerEmployersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CustomerEmployersToolStripMenuItem.Click
        Dim vrl As New CustomerEmployers
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub EmployerProductsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EmployerProductsToolStripMenuItem.Click
        Dim vrl As New EmployerProducts
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub UploadCustomerDetailsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UploadCustomerDetailsToolStripMenuItem.Click
        Dim vrl As New UploadCustomers
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub CompareDatabaseStructuresToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CompareDatabaseStructuresToolStripMenuItem.Click
        Dim vrl As New CompareDatabaseTables
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub SalesAgentsCustomersToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SalesAgentsCustomersToolStripMenuItem1.Click
        Dim vrl As New SalesCustomers
        vrl.MdiParent = mform
        vrl.Show()
    End Sub
    ...
    Private Sub SalesReportToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SalesReportToolStripMenuItem1.Click
        Dim vrl As New SalesProducts
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub UplaodSalesCustomersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UplaodSalesCustomersToolStripMenuItem.Click
        Dim vrl As New UploadSalesCustomers
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub UploadBankBranchesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UploadBankBranchesToolStripMenuItem.Click
        Dim vrl As New UploadBankBranches
        vrl.MdiParent = mform
        vrl.Show()
    End Sub

    Private Sub EmployerChangesHistoryCustomerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EmployerChangesHistoryCustomerToolStripMenuItem.Click
        Dim vrl As New EmployerAndGroupChanges
        vrl.MdiParent = mform
        vrl.Show()
    End Sub
