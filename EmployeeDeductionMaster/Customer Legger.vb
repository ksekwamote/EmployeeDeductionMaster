...
Public Class Customer_Legger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EmployeeDeductionMaster.Customer Legger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomer_Legger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Customer_Legger = New Customer_Legger()
        rpt.Site = Me.Site
        Return rpt
    End Function
