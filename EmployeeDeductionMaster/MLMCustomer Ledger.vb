...
Public Class MLMCustomer_Ledger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EmployeeDeductionMaster.MLMCustomer Ledger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMLMCustomer_Ledger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MLMCustomer_Ledger = New MLMCustomer_Ledger()
        rpt.Site = Me.Site
        Return rpt
    End Function
