...
Module Methods
    ...
    Public Sub saveProduct(ByVal Products As String, ByVal AllocationOrder As Integer, ByVal Status As String, ByVal AutoCalculate As Integer, ByVal HasSystem As Integer, ByVal SystemAbreviatedName As String, ByVal UseInCheques As String, ByVal UseInSettlement As String, ByVal UseInReceipts As String, ByVal SalesProduct As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "Insert into Products values ('" & Products & "','" & AllocationOrder & "','" & Status & "','" & AutoCalculate & "','" & HasSystem & "','" & SystemAbreviatedName & "','" & UseInCheques & "','" & UseInSettlement & "','" & UseInReceipts & "','" & SalesProduct & "')"
    ...
    Public Sub updateProduct(ByVal autoid As Integer, ByVal Products As String, ByVal Status As String, ByVal AllocationOrder As Integer, ByVal AutoCalculate As Integer, ByVal HasSystem As Integer, ByVal SystemAbreviatedName As String, ByVal UseInCheques As String, ByVal UseInSettlement As String, ByVal UseInReceipts As String, ByVal SalesProduct As String)
        ...
        Try
            ...
            Dim qryinsert As String = "update Products set Products = '" & Products & "',AllocationOrder = '" & AllocationOrder & "',Status = '" & Status & "',AutoAllocate = '" & AutoCalculate & "',HasSystem = '" & HasSystem & "',SystemAbreviatedName = '" & SystemAbreviatedName & "',UseInCheques = '" & UseInCheques & "',UseInSettlement = '" & UseInSettlement & "',UseInReceipts = '" & UseInReceipts & "',SalesProduct = '" & SalesProduct & "' where AutoID = '" & autoid & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Sub saveEmployers(ByVal EmployerName As String, ByVal CommissionPercent As Decimal, ByVal ProductID As Integer, ByVal AllowToEdit As String, ByVal RMOEmployer As String, ByVal RMBEmployer As String, ByVal MLMAEmployer As String, ByVal MLMEEmployer As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
            transactioninsert = con.BeginTransaction()
            Dim qryinsert As String = "Insert into Employers values ('" & EmployerName & "','" & CommissionPercent & "','" & ProductID & "','" & AllowToEdit & "','" & RMOEmployer & "','" & RMBEmployer & "','" & MLMAEmployer & "','" & MLMEEmployer & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            cmdinsert.Transaction = transactioninsert
            If cmdinsert.ExecuteNonQuery() Then
                transactioninsert.Commit()
    ...
    Public Function getEmployerNameByEmployerID(ByVal EmployerID As Integer) As String
        Dim qry As String = "select EmployerName from Employers where AutoID = '" & EmployerID & "'"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getEmployerNameByEmployerID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getEmployerNameByEmployerID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Sub updateCustomer(ByVal Title As String, ByVal CountryID As String, ByVal IdentityTypeID As String, ByVal IdentityExpiryDate As Date, ByVal IDNumber As String, ByVal FirstNames As String, ByVal Surname As String, ByVal DateOfBirth As Date, ByVal GenderID As String, ByVal CellNumber As String, ByVal Email As String, ByVal PostalAddress As String, ByVal HomeTelephone As String, ByVal RegionID As String, ByVal TownVillageID As String, ByVal Area As String, ByVal Ward As String, ByVal Chief As String, ByVal HomePhysicalAddress As String, ByVal SchoolID As String, ByVal EmployerID As String, ByVal DepartmentID As String, ByVal Occupation As String, ByVal WorkPostalAddress As String, ByVal WorkPhysicalAddress As String, ByVal WorkEmailAddress As String, ByVal EmploymentTypeID As String, ByVal EmployerContactPerson As String, ByVal DateOfEngagement As Date, ByVal EmpTelephone1 As String, ByVal EmpTelephone2 As String, ByVal EmpFax_1 As String, ByVal EmpFax_2 As String, ByVal NextOfKinName1 As String, ByVal NextOfKinID1 As String, ByVal NextOfKinContact1 As String, ByVal NextOfKinAddress1 As String, ByVal NextOfKinName2 As String, ByVal NextOfKinID2 As String, ByVal NextOfKinContact2 As String, ByVal NextOfKinAddress2 As String, ByVal NetSalary As Decimal, ByVal BankID As String, ByVal BankBranchID As String, ByVal AccountNumber As String, ByVal LastModified As Date, ByVal GroupID As String, ByVal PayrolNumber As String, ByVal AutoID As Integer)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update Customers set Title = '" & Title & "',CountryID = '" & CountryID & "',IdentityTypeID = '" & IdentityTypeID & "',IdentityExpiryDate = '" & IdentityExpiryDate & "',IDNumber = '" & IDNumber & "',FirstNames = '" & FirstNames & "',Surname = '" & Surname & "',DateOfBirth = '" & DateOfBirth & "',GenderID = '" & GenderID & "',CellNumber = '" & CellNumber & "',Email = '" & Email & "',PostalAddress = '" & PostalAddress & "',HomeTelephone = '" & HomeTelephone & "',RegionID = '" & RegionID & "',TownVillageID = '" & TownVillageID & "',Area = '" & Area & "',Ward = '" & Ward & "',Chief = '" & Chief & "',HomePhysicalAddress = '" & HomePhysicalAddress & "',SchoolID = '" & SchoolID & "',EmployerID = '" & EmployerID & "',DepartmentID = '" & DepartmentID & "',Occupation = '" & Occupation & "',WorkPostalAddress = '" & WorkPostalAddress & "',WorkPhysicalAddress = '" & WorkPhysicalAddress & "',WorkEmailAddress = '" & WorkEmailAddress & "',EmploymentTypeID = '" & EmploymentTypeID & "',EmployerContactPerson = '" & EmployerContactPerson & "',DateOfEngagement = '" & DateOfEngagement & "',EmpTelephone1 = '" & EmpTelephone1 & "',EmpTelephone2 = '" & EmpTelephone2 & "',EmpFax_1 = '" & EmpFax_1 & "',EmpFax_2 = '" & EmpFax_2 & "',NextOfKinName1 = '" & NextOfKinName1 & "',NextOfKinID1 = '" & NextOfKinID1 & "',NextOfKinContact1 = '" & NextOfKinContact1 & "',NextOfKinAddress1 = '" & NextOfKinAddress1 & "',NextOfKinName2 = '" & NextOfKinName2 & "',NextOfKinID2 = '" & NextOfKinID2 & "',NextOfKinContact2 = '" & NextOfKinContact2 & "',NextOfKinAddress2 = '" & NextOfKinAddress2 & "',NetSalary = '" & NetSalary & "',BankID = '" & BankID & "',BankBranchID = '" & BankBranchID & "',AccountNumber = '" & AccountNumber & "',LastModified = '" & LastModified & "',GroupID = '" & GroupID & "',PayrolNumber = '" & PayrolNumber & "' where AutoID = '" & AutoID & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "updateCustomer()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "updateCustomer()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub saveStatus(ByVal Status As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "Insert into Status values ('" & Status & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveStatus()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveStatus()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Function checkStatus() As Boolean
        Dim qry As String = "select * from Status"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "checkStatus()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "checkStatus()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function checkIfProductHasAGroup(ByVal ProductID As Integer, ByVal EmployerID As Integer) As Boolean
        Dim qry As String = "select * from EmployerProductGrouping where ProductID = '" & ProductID & "' and EmployerID = '" & EmployerID & "' and Status = 'Active'"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "checkIfProductHasAGroup()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "checkIfProductHasAGroup()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getProductGroupingName(ByVal ProductID As Integer, ByVal Employerid As Integer) As String
        Dim qry As String = "select ProductGroupingName from ProductGrouping where AutoID in (select ProductGroupingID from EmployerProductGrouping where ProductID = '" & ProductID & "' and EmployerID = '" & Employerid & "' and Status = 'Active')"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getProductGroupingName()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getProductGroupingName()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Sub saveGroupingBreakdown(ByVal ProductID As Integer, ByVal ProductName As String, ByVal Balance As Decimal, ByVal Instalment As Decimal, ByVal GroupingName As String, ByVal BatchName As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "Insert into GroupingBreakdown values ('" & ProductID & "','" & ProductName & "','" & Balance & "','" & Instalment & "','" & GroupingName & "','" & BatchName & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveGroupingBreakdown()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveGroupingBreakdown()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub deleteGroupingBreakdown(ByVal BatchName As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "delete from GroupingBreakdown where BatchName = '" & BatchName & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "deleteGroupingBreakdown()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "deleteGroupingBreakdown()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Function checkIfCustomerGroupIsForMerging(ByVal IDNumber As String, ByVal con As SqlClient.SqlConnection) As Boolean
        Dim qry As String = "select * from CustomerDetails where GroupID in (select GroupID from MembershipFuneralMerger where Status = 'Active') and IDNumber = '" & IDNumber & "'"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "checkIfCustomerGroupIsForMerging()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "checkIfCustomerGroupIsForMerging()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getValueStringOtherSystems(ByVal str As String, ByVal con As SqlClient.SqlConnection) As String
        Dim qry As String = str
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getValueStringOtherSystems()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getValueStringOtherSystems()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getValueBooleanOtherSystems(ByVal str As String, ByVal con As SqlClient.SqlConnection) As String
        Dim qry As String = str
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getValueBooleanOtherSystems()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getValueBooleanOtherSystems()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getSalesCustomerValidity() As Integer
        Dim qry As String = "select SalesCustomerVilidity from CompanyDetails"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getSalesCustomerValidity()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getSalesCustomerValidity()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getSalesCustomers(ByVal enddate As String) As DataSet
        Dim qry As String = "select CustomerID,CellNumber,ContactedDate,ValidityDate,AgentIDNumber,SalesCustomers.FullName,SalesAgents.Fullname from SalesCustomers inner join SalesAgents on SalesCustomers.AgentIDNumber = SalesAgents.IDNumber where ValidityDate >= '" & enddate & "' and ContactedDate <= '" & enddate & "'"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getSalesCustomers()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getSalesCustomers()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return ds
    ...
    Public Function getSalesProductsSystems() As DataSet
        Dim qry As String = "select AutoID,SystemAbreviatedName from Products where SalesProduct = 'Yes'"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getSalesProductsSystems()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getSalesProductsSystems()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return ds
    ...
    Public Function getDataset(ByVal str As String, ByVal con As SqlClient.SqlConnection) As DataSet
        Dim qry As String = ""
        qry = str
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "getDataset()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getDataset()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return ds
    ...
    Public Function getMembershipFeeByGroupID(ByVal groupid As Integer, ByVal con As SqlClient.SqlConnection) As Decimal
        Dim qry As String = "select MembershipFee from Groups where GroupID = '" & groupid & "'"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "getMembershipFeeByGroupID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getMembershipFeeByGroupID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function GetGroupIDByCustomerID(ByVal IDNumber As String, ByVal con As SqlClient.SqlConnection) As Integer
        Dim qry As String = "select GroupID from CustomerDetails where IDNumber = '" & IDNumber & "'"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "GetGroupIDByCustomerID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "GetGroupIDByCustomerID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getTotalPremiumPerPolicyNumberPrincipalIDandCoverStartDate(ByVal sdate As Date, ByVal edate As Date, ByVal InitiatedByIDNumber As String, ByVal PolicyNumber As Integer, ByVal con As SqlClient.SqlConnection) As Decimal
        Dim qry As String = "select SUM(Premium) from PolicyCovers inner join Policy on PolicyCovers.PolicyNumber = Policy.PolicyNumber where CoverStartDate between '" & sdate & "' and '" & edate & "' and Status in ('Active') and InitiatedByIDNumber = '" & InitiatedByIDNumber & "' and PolicyCovers.PolicyNumber = '" & PolicyNumber & "'"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "getTotalPremiumPerPolicyNumberPrincipalIDandCoverStartDate()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getTotalPremiumPerPolicyNumberPrincipalIDandCoverStartDate()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function getTotalPremiumPerPolicyNumberPrincipalIDandBenefitStartDate(ByVal sdate As Date, ByVal edate As Date, ByVal InitiatedByIDNumber As String, ByVal PolicyNumber As Integer, ByVal con As SqlClient.SqlConnection) As Decimal
        Dim qry As String = "select SUM(Premium) from PolicyBenefits inner join Policy on PolicyBenefits.PolicyNumber = Policy.PolicyNumber where BenefitStartDate between '" & sdate & "' and '" & edate & "' and Status in ('Active') and InitiatedByIDNumber = '" & InitiatedByIDNumber & "' and PolicyBenefits.PolicyNumber = '" & PolicyNumber & "'"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "getTotalPremiumPerPolicyNumberPrincipalIDandBenefitStartDate()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "getTotalPremiumPerPolicyNumberPrincipalIDandBenefitStartDate()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function checkLocationID(ByVal str As String, ByVal con As SqlClient.SqlConnection) As Boolean
        Dim qry As String = ""
        qry = str
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                If ds.Tables(0).Rows(0).IsNull(0) Then
                    perc = False
                Else
                    If Integer.Parse(ds.Tables(0).Rows(0).Item(0).ToString) > 0 Then
                        perc = True
                    Else
                        perc = False
                    End If
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "checkRegionID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "checkRegionID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Sub saveSchool(ByVal SchoolID As String, ByVal SchoolName As String, ByVal Status As String, ByVal FPMSchool As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into School values ('" & SchoolID & "','" & SchoolName & "','" & Status & "','" & FPMSchool & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Sub updateSchool(ByVal SchoolID As String, ByVal SchoolName As String, ByVal FPMSchool As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update School set SchoolName = '" & SchoolName & "',FPMSchool = '" & FPMSchool & "' where SchoolID = '" & SchoolID & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Function getNextSchoolID(ByVal str As String) As String
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                While go = False
                    perc = str & int
                    If CheckID("select * from School where SchoolID = '" & perc & "'") = True Then
                        int = int + 1
                    Else
                        go = True
                    End If
    ...
    Public Sub saveDocumentNumber(ByVal CustomerID As String, ByVal Type As String, ByVal TypeID As Integer, ByVal FillingNumber As String, ByVal CapturedBy As String, ByVal CapturedDate As Date, ByVal Status As String, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "Insert into FillingDocuments values ('" & CustomerID & "','" & Type & "','" & TypeID & "','" & FillingNumber & "','" & CapturedBy & "','" & CapturedDate & "','" & Status & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveDocumentNumber()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveDocumentNumber()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Function getStringValue(ByVal str As String, ByVal con As SqlClient.SqlConnection) As String
        Dim qry As String = ""
        qry = str
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.StackTrace, "getStringValue()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Sub saveDepartment(ByVal DepartmentID As String, ByVal DepartmentName As String, ByVal Status As String, ByVal RMODepartment As String, ByVal RMBDepartment As String, ByVal MLMADepartment As String, ByVal MLMEDepartment As String, ByVal FPMDepartment As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into Department values ('" & DepartmentID & "','" & DepartmentName & "','" & Status & "','" & RMODepartment & "','" & RMBDepartment & "','" & MLMADepartment & "','" & MLMEDepartment & "','" & FPMDepartment & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Sub updateDepartment(ByVal DepartmentID As String, ByVal DepartmentName As String, ByVal RMODepartment As String, ByVal RMBDepartment As String, ByVal MLMADepartment As String, ByVal MLMEDepartment As String, ByVal FPMDepartment As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update Department set DepartmentName = '" & DepartmentName & "',RMODepartment = '" & RMODepartment & "',RMBDepartment = '" & RMBDepartment & "',MLMADepartment = '" & MLMADepartment & "',MLMEDepartment = '" & MLMEDepartment & "',FPMDepartment = '" & FPMDepartment & "' where DepartmentID = '" & DepartmentID & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Function getNextDepartmentID(ByVal str As String) As String
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                While go = False
                    perc = str & int
                    If CheckID("select * from Department where DepartmentID = '" & perc & "'") = True Then
                        int = int + 1
                    Else
                        go = True
                    End If
    ...
    Public Function CheckDepartmentName(ByVal departmentname As String) As Boolean
        Dim qry As String = "select * from Department where DepartmentName = '" & departmentname & "'"
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "CheckDepartmentName()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "CheckDepartmentName()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Function CheckID(ByVal str As String) As Boolean
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "CheckID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "CheckID()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Sub updateAction(ByVal str As String, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "updateAction()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "updateAction()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub saveReceiptPayerInfor(ByVal PayerID As String, ByVal PayerCellNumber As String, ByVal ReceivedFromID As String, ByVal ReceivedFromName As String, ByVal ReceivedFromContact As String, ByVal Description As String, ByVal BatchName As String, ByVal PayerName As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into ReceiptPayerInfor values ('" & PayerID & "','" & PayerCellNumber & "','" & ReceivedFromID & "','" & ReceivedFromName & "','" & ReceivedFromContact & "','" & Description & "','" & BatchName & "','" & PayerName & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveReceiptPayerInfor()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveReceiptPayerInfor()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Function checkItem(ByVal str As String, ByVal con As SqlClient.SqlConnection) As Boolean
        Dim qry As String = ""
        qry = str
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "checkItem()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "checkItem()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            con.Close()
        End Try
        Return perc
    ...
    Public Sub SaveFPMCustomerDetails(ByVal Title As String, ByVal IDNumber As String, ByVal FirstName As String, ByVal Surname As String, ByVal DateOfBirth As Date, ByVal Gender As String, ByVal Telephone As String, ByVal PostalAddress As String, ByVal CellNumber As String, ByVal Email As String, ByVal AreaCode As String, ByVal GroupID As Integer, ByVal Occupation As String, ByVal Status As String, ByVal DateOfDeath As Date, ByVal PlaceOfDeath As String, ByVal CreationDate As Date, ByVal Nationality As String, ByVal HomeAddress As String, ByVal SchoolID As Integer, ByVal DepID As Integer, ByVal RegionID As Integer, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "Insert into CustomerDetails values ('" & Title & "','" & IDNumber & "','" & FirstName & "','" & Surname & "','" & DateOfBirth & "','" & Gender & "','" & Telephone & "','" & PostalAddress & "','" & CellNumber & "','" & Email & "','" & AreaCode & "','" & GroupID & "','" & Occupation & "','" & Status & "','" & DateOfDeath & "','" & PlaceOfDeath & "','" & CreationDate & "','" & Nationality & "','" & HomeAddress & "','" & SchoolID & "','" & DepID & "','" & RegionID & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "saveFPMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveFPMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub UpdateFPMCustomerDetails(ByVal Title As String, ByVal IDNumber As String, ByVal FirstName As String, ByVal Surname As String, ByVal DateOfBirth As Date, ByVal Gender As String, ByVal Telephone As String, ByVal PostalAddress As String, ByVal CellNumber As String, ByVal Email As String, ByVal AreaCode As String, ByVal GroupID As Integer, ByVal Occupation As String, ByVal Nationality As String, ByVal HomeAddress As String, ByVal SchoolID As Integer, ByVal DepID As Integer, ByVal RegionID As Integer, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update CustomerDetails set Title= '" & Title & "',IDNumber= '" & IDNumber & "',FirstName= '" & FirstName & "',Surname= '" & Surname & "',DateOfBirth= '" & DateOfBirth & "',Gender= '" & Gender & "',Telephone='" & Telephone & "',PostalAddress= '" & PostalAddress & "',CellNumber= '" & CellNumber & "',Email= '" & Email & "',AreaCode= '" & AreaCode & "',GroupID= '" & GroupID & "',Occupation= '" & Occupation & "',Nationality= '" & Nationality & "',HomeAddress= '" & HomeAddress & "',SchoolID= '" & SchoolID & "',DepID= '" & DepID & "',RegionID= '" & RegionID & "' where IDNumber = '" & IDNumber & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.Message, "updateFPMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "updateFPMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub saveMLMCustomerDetails(ByVal First_Name As String, ByVal Surname As String, ByVal ID_Number As String, ByVal Date_Of_Birth As Date, ByVal Mobile_Number As String, ByVal Home_Telephone As String, ByVal Name_Of_Employer As String, ByVal Employer_Telephone As String, ByVal Postal_Address As String, ByVal Residential_Address As String, ByVal Home_Village As String, ByVal Home_Ward As String, ByVal Chief As String, ByVal Next_Of_Kin_1_Name As String, ByVal Next_Of_Kin_1_ID_Number As String, ByVal Next_Of_Kin_1_Mobile_Number1 As String, ByVal Next_Of_Kin_1_Address As String, ByVal Next_Of_Kin_2_Name As String, ByVal Next_Of_Kin_2_ID_Number As String, ByVal Next_Of_Kin_2_Mobile_Number1 As String, ByVal Next_Of_Kin_2_Address As String, ByVal Gender As String, ByVal EmployerContactPerson As String, ByVal EmployerType As String, ByVal DateOfEngagement As Date, ByVal NetSalary As Decimal, ByVal BankName As String, ByVal BranchName As String, ByVal AccountNumber As String, ByVal BranchID As Integer, ByVal EmployerID As Integer, ByVal DepartmentID As Integer, ByVal GroupID As Integer, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into CustomerDetails values ('" & First_Name & "','" & Surname & "','" & ID_Number & "','" & Date_Of_Birth & "','" & Mobile_Number & "','" & Home_Telephone & "','" & Name_Of_Employer & "','" & Employer_Telephone & "','" & Postal_Address & "','" & Residential_Address & "','" & Home_Village & "','" & Home_Ward & "','" & Chief & "','" & Next_Of_Kin_1_Name & "','" & Next_Of_Kin_1_ID_Number & "','" & Next_Of_Kin_1_Mobile_Number1 & "','" & Next_Of_Kin_1_Address & "','" & Next_Of_Kin_2_Name & "','" & Next_Of_Kin_2_ID_Number & "','" & Next_Of_Kin_2_Mobile_Number1 & "','" & Next_Of_Kin_2_Address & "','" & Gender & "','" & EmployerContactPerson & "','" & EmployerType & "','" & DateOfEngagement & "','" & NetSalary & "','" & BankName & "','" & BranchName & "','" & AccountNumber & "','" & BranchID & "','" & EmployerID & "','" & DepartmentID & "','" & GroupID & "')"
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveMLMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub updateMLMCustomerDetails(ByVal First_Name As String, ByVal Surname As String, ByVal ID_Number As String, ByVal Date_Of_Birth As Date, ByVal Mobile_Number As String, ByVal Home_Telephone As String, ByVal Name_Of_Employer As String, ByVal Employer_Telephone As String, ByVal Postal_Address As String, ByVal Residential_Address As String, ByVal Home_Village As String, ByVal Home_Ward As String, ByVal Chief As String, ByVal Next_Of_Kin_1_Name As String, ByVal Next_Of_Kin_1_ID_Number As String, ByVal Next_Of_Kin_1_Mobile_Number1 As String, ByVal Next_Of_Kin_1_Address As String, ByVal Next_Of_Kin_2_Name As String, ByVal Next_Of_Kin_2_ID_Number As String, ByVal Next_Of_Kin_2_Mobile_Number1 As String, ByVal Next_Of_Kin_2_Address As String, ByVal Gender As String, ByVal EmployerContactPerson As String, ByVal EmployerType As String, ByVal DateOfEngagement As Date, ByVal NetSalary As Decimal, ByVal BankName As String, ByVal BranchName As String, ByVal AccountNumber As String, ByVal EmployerID As Integer, ByVal DepartmentID As Integer, ByVal GroupID As Integer, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "UPDATE CustomerDetails SET First_Name = '" & First_Name & "',Surname = '" & Surname & "',Date_Of_Birth = '" & Date_Of_Birth & "',Mobile_Number = '" & Mobile_Number & "',Home_Telephone = '" & Home_Telephone & "',Name_Of_Employer = '" & Name_Of_Employer & "',Employer_Telephone = '" & Employer_Telephone & "',Postal_Address = '" & Postal_Address & "',Residential_Address = '" & Residential_Address & "',Home_Village = '" & Home_Village & "',Home_Ward = '" & Home_Ward & "',Chief = '" & Chief & "' ,Next_Of_Kin_1_Name = '" & Next_Of_Kin_1_Name & "',Next_Of_Kin_1_ID_Number = '" & Next_Of_Kin_1_ID_Number & "',Next_Of_Kin_1_Mobile_Number1 = '" & Next_Of_Kin_1_Mobile_Number1 & "',Next_Of_Kin_1_Address = '" & Next_Of_Kin_1_Address & "',Next_Of_Kin_2_Name = '" & Next_Of_Kin_2_Name & "',Next_Of_Kin_2_ID_Number = '" & Next_Of_Kin_2_ID_Number & "' ,Next_Of_Kin_2_Mobile_Number1 = '" & Next_Of_Kin_2_Mobile_Number1 & "' ,Next_Of_Kin_2_Address = '" & Next_Of_Kin_2_Address & "',Gender = '" & Gender & "',EmployerContactPerson = '" & EmployerContactPerson & "',EmployerType = '" & EmployerType & "',DateOfEngagement = '" & DateOfEngagement & "',NetSalary = '" & NetSalary & "',BankName = '" & BankName & "',BranchName = '" & BranchName & "',AccountNumber = '" & AccountNumber & "',EmployerID = '" & EmployerID & "',DepartmentID = '" & DepartmentID & "',GroupID = '" & GroupID & "' WHERE ID_Number = '" & ID_Number & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "updateMLMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub saveRMCustomerDetails(ByVal Nationality As String, ByVal Account As String, ByVal Surname As String, ByVal FirstName As String, ByVal Gender As String, ByVal EmployerCode As String, ByVal EmployerDeptCode As String, ByVal EmployerTel_1 As String, ByVal EmployerTel_2 As String, ByVal EmployerFax_1 As String, ByVal EmployerFax_2 As String, ByVal Position As String, ByVal Location As String, ByVal PostalAddress As String, ByVal CurrentPhysicalAddress As String, ByVal HomeAddress As String, ByVal NextOfKinName As String, ByVal NextOfKinID As String, ByVal NextOfKinContact As String, ByVal Contact As String, ByVal Region As String, ByVal Town_Village As String, ByVal Area As String, ByVal Ward As String, ByVal Chief As String, ByVal Homephone As String, ByVal NextOfKinName2 As String, ByVal NextOfKinID2 As String, ByVal NextOfKinContact2 As String, ByVal DateOfBirth As Date, ByVal WorkPostalAddress As String, ByVal WorkPhysicalAddress As String, ByVal WorkEmailAddress As String, ByVal YourEmailAddress As String, ByVal NextOfKinAddress As String, ByVal NextOfKinAddress2 As String, ByVal Exported As Boolean, ByVal BranchID As Integer, ByVal ExpiryDate As Date, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "Insert into CustomerMaster values ('" & Nationality & "','" & Account & "','" & Surname & "','" & FirstName & "','" & Gender & "','" & EmployerCode & "','" & EmployerDeptCode & "','" & EmployerTel_1 & "','" & EmployerTel_2 & "','" & EmployerFax_1 & "','" & EmployerFax_2 & "','" & Position & "','" & Location & "','" & PostalAddress & "','" & CurrentPhysicalAddress & "','" & HomeAddress & "','" & NextOfKinName & "','" & NextOfKinID & "','" & NextOfKinContact & "','" & Contact & "','" & Region & "','" & Town_Village & "','" & Area & "','" & Ward & "','" & Chief & "','" & Homephone & "','" & NextOfKinName2 & "','" & NextOfKinID2 & "','" & NextOfKinContact2 & "','" & DateOfBirth & "','" & WorkPostalAddress & "','" & WorkPhysicalAddress & "','" & WorkEmailAddress & "','" & YourEmailAddress & "','" & NextOfKinAddress & "','" & NextOfKinAddress2 & "','" & Exported & "','" & BranchID & "','" & ExpiryDate & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveRMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(Account, "saveRMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveRMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Sub updateRMCustomerDetails(ByVal Nationality As String, ByVal Account As String, ByVal Surname As String, ByVal FirstName As String, ByVal Gender As String, ByVal EmployerCode As String, ByVal EmployerDeptCode As String, ByVal EmployerTel_1 As String, ByVal EmployerTel_2 As String, ByVal EmployerFax_1 As String, ByVal EmployerFax_2 As String, ByVal Position As String, ByVal Location As String, ByVal PostalAddress As String, ByVal CurrentPhysicalAddress As String, ByVal HomeAddress As String, ByVal NextOfKinName As String, ByVal NextOfKinID As String, ByVal NextOfKinContact As String, ByVal Contact As String, ByVal Region As String, ByVal Town_Village As String, ByVal Area As String, ByVal Ward As String, ByVal Chief As String, ByVal Homephone As String, ByVal NextOfKinName2 As String, ByVal NextOfKinID2 As String, ByVal NextOfKinContact2 As String, ByVal DateOfBirth As Date, ByVal WorkPostalAddress As String, ByVal WorkPhysicalAddress As String, ByVal WorkEmailAddress As String, ByVal YourEmailAddress As String, ByVal NextOfKinAddress As String, ByVal NextOfKinAddress2 As String, ByVal Exported As Boolean, ByVal IdentityExpiryDate As Date, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update CustomerMaster set Nationality = '" & Nationality & "',Surname = '" & Surname & "',FirstName = '" & FirstName & "',Gender = '" & Gender & "',EmployerCode = '" & EmployerCode & "',EmployerDeptCode = '" & EmployerDeptCode & "',EmployerTel_1 = '" & EmployerTel_1 & "',EmployerTel_2 = '" & EmployerTel_2 & "',EmployerFax_1 = '" & EmployerFax_1 & "',EmployerFax_2 = '" & EmployerFax_2 & "',Position = '" & Position & "',Location = '" & Location & "',PostalAddress = '" & PostalAddress & "',CurrentPhysicalAddress = '" & CurrentPhysicalAddress & "',HomeAddress = '" & HomeAddress & "',NextOfKinName = '" & NextOfKinName & "',NextOfKinID = '" & NextOfKinID & "',NextOfKinContact = '" & NextOfKinContact & "',Contact = '" & Contact & "',Region = '" & Region & "',Town_Village = '" & Town_Village & "',Area = '" & Area & "',Ward = '" & Ward & "',Chief = '" & Chief & "',Homephone = '" & Homephone & "',NextOfKinName2 = '" & NextOfKinName2 & "',NextOfKinID2 = '" & NextOfKinID2 & "',NextOfKinContact2 = '" & NextOfKinContact2 & "',DateOfBirth = '" & DateOfBirth & "',WorkPostalAddress = '" & WorkPostalAddress & "',WorkPhysicalAddress = '" & WorkPhysicalAddress & "',WorkEmailAddress = '" & WorkEmailAddress & "',YourEmailAddress = '" & YourEmailAddress & "',NextOfKinAddress = '" & NextOfKinAddress & "',NextOfKinAddress2 = '" & NextOfKinAddress2 & "',Exported = '" & Exported & "',IdentityExpiryDate = '" & IdentityExpiryDate & "' where Account = '" & Account & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "updateRMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "updateRMCustomerDetails()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub doAction(ByVal str As String, ByVal con As SqlClient.SqlConnection)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = str
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "doAction()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "doAction()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub saveSalesCommission(ByVal CustomerID As String, ByVal CustomerName As String, ByVal CellNumber As String, ByVal ContactedDate As Date, ByVal ValidityDate As Date, ByVal Product As String, ByVal CapturedDate As Date, ByVal Value As Decimal, ByVal AgentID As String, ByVal AgentName As String, ByVal ProductAutoID As Integer, ByVal Status As String, ByVal BatchName As String, ByVal SavedDate As Date, ByVal SavedBy As String, ByVal SystemName As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into SalesCommission values ('" & CustomerID & "','" & CustomerName & "','" & CellNumber & "','" & ContactedDate & "','" & ValidityDate & "','" & Product & "','" & CapturedDate & "','" & Value & "','" & AgentID & "','" & AgentName & "','" & ProductAutoID & "','" & Status & "','" & BatchName & "','" & SavedDate & "','" & SavedBy & "','" & SystemName & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
        ...
        Catch ex As Exception
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            MessageBox.Show(ex.Message, "saveSalesCommission()", MessageBoxButtons.OK, MessageBoxIcon.Error)
            MessageBox.Show(ex.StackTrace, "saveSalesCommission()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
    ...
    Public Sub saveBankBranch(ByVal BankBranchID As String, ByVal BankBranchName As String, ByVal BankID As String, ByVal Status As String, ByVal BranchCode As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into BankBranch values ('" & BankBranchID & "','" & BankBranchName & "','" & BankID & "','" & Status & "','" & BranchCode & "')"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Sub updateBankBranch(ByVal BankBranchID As String, ByVal BankBranchName As String, ByVal BranchCode As String, ByVal BankID As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update BankBranch set BankBranchName = '" & BankBranchName & "',BankID = '" & BankID & "',BranchCode = '" & BranchCode & "' where BankBranchID = '" & BankBranchID & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
    ...
    Public Function getNextBankBranchID(ByVal str As String) As String
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                Dim int As Integer = 0
                int = Integer.Parse(ds.Tables(0).Rows(0).Item(0).ToString.Substring(6)) + 1
                Dim go As Boolean = False
                While go = False
                    perc = str & int
                    If CheckID("select * from BankBranch where BankBranchID = '" & perc & "'") = True Then
                        int = int + 1
                    Else
                        go = True
                    End If
    ...
    Public Function getDateValue(ByVal str As String, ByVal con As SqlClient.SqlConnection) As Date
        Dim qry As String = str
