...
Public Class Group
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If tbgroupid.Text.Trim = "" Or tbgroup.Text.Trim = "" Or tbfpmid.Text.Trim = "" Or tbmlmaid.Text.Trim = "" Or tbmlmeid.Text.Trim = "" Then
            ...
            Else
                If decision("Are you sure to proceed ?") = DialogResult.Yes Then
                    saveGroup(tbgroupid.Text.Trim, tbgroup.Text.Trim, "Active", tbfpmid.Text.Trim, tbmlmaid.Text.Trim, tbmlmeid.Text.Trim)
                    loadGroup()
                    clearText()
                End If
            End If
    ...
    Private Sub DataGridView1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.Click
        If DataGridView1.Rows.Count > 0 Then
            ...
            tbfpm.Text = getValueStringOtherSystems("select GroupName from Groups where GroupID = '" & tbfpmid.Text.Trim & "'", conFPM)
            tbmlmaid.Text = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(4).Value.ToString()
            tbmlma.Text = getValueStringOtherSystems("select GroupName from Groups where GroupID = '" & tbmlmaid.Text.Trim & "'", conMLMAdvances)
            tbmlmeid.Text = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(5).Value.ToString()
            tbmlme.Text = getValueStringOtherSystems("select GroupName from Groups where GroupID = '" & tbmlmeid.Text.Trim & "'", conMLMEducational)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            If tbgroupid.Text = "" Or tbgroup.Text.Trim = "" Or tbfpmid.Text.Trim = "" Or tbmlmaid.Text.Trim = "" Or tbmlmeid.Text.Trim = "" Then
            ...
            Else
                If decision("Are you sure to proceed ?") = DialogResult.Yes Then
                    updateGroup(tbgroupid.Text.Trim, tbgroup.Text.Trim, tbfpmid.Text.Trim, tbmlmaid.Text.Trim, tbmlmeid.Text.Trim)
                    loadGroup()
                    clearText()
                End If
            End If
    ...
    Public Function getNextGroupID(ByVal str As String) As String
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                While go = False
                    perc = str & int
                    If CheckID("select * from Groups where GroupID = '" & perc & "'") = True Then
                        int = int + 1
                    Else
                        go = True
                    End If
    ...
    Public Sub saveGroup(ByVal GroupID As String, ByVal GroupName As String, ByVal Status As String, ByVal FPMGroup As String, ByVal MLMAGroup As String, ByVal MLMEGroup As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into Groups values ('" & GroupID & "','" & GroupName & "','" & Status & "','" & FPMGroup & "','" & MLMAGroup & "','" & MLMEGroup & "')"
    ...
    Public Sub updateGroup(ByVal GroupID As String, ByVal GroupName As String, ByVal FPMGroup As String, ByVal MLMAGroup As String, ByVal MLMEGroup As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update Groups set GroupName = '" & GroupName & "',FPMGroup = '" & FPMGroup & "',MLMAGroup = '" & MLMAGroup & "',MLMEGroup = '" & MLMEGroup & "' where GroupID = '" & GroupID & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
