Public Class DailyChequesReport
    ...
    Private Sub loadCheques(ByVal sdate As Date, ByVal edate As Date, ByVal Status As String, ByVal PayBy As String, ByVal dgv As DataGridView, ByVal bn As BindingNavigator)
        ...
        Dim qry As String = "select ProductID,ChequeNumber,ProductsCheques.CustomerID,CustomerName,Amount as TotalAmount,'' as Others,'' as Loan,'' as Quick,PayeeName,AccountNumber,Bank,BranchCode,PaymentDate,CapturedDate from ProductsCheques inner join CustomerDetails on ProductsCheques.CustomerID = CustomerDetails.CustomerID where PaymentDate between '" & sdate & "' and '" & edate & "' and PayBy = '" & PayBy & "' and ChequeNumber not in ('')"
    ...
    Private Sub loadChequesAll(ByVal Status As String, ByVal PayBy As String, ByVal dgv As DataGridView, ByVal bn As BindingNavigator)
        ...
        Dim qry As String = "select ProductID,ChequeNumber,ProductsCheques.CustomerID,CustomerName,Amount as TotalAmount,'' as Others,'' as Loan,'' as Quick,PayeeName,AccountNumber,Bank,BranchCode,PaymentDate,CapturedDate from ProductsCheques inner join CustomerDetails on ProductsCheques.CustomerID = CustomerDetails.CustomerID where PayBy = '" & PayBy & "' and ChequeNumber not in ('')"
        Dim ds As New DataSet
        Dim cmd As New SqlClient.SqlCommand(qry, con)
        Dim SQLAdapter As New System.Data.SqlClient.SqlDataAdapter(cmd)
        Dim dt As DataTable
    ...
    Private Sub loadChequesAllPerCustomerID(ByVal customerid As String, ByVal Status As String, ByVal PayBy As String, ByVal dgv As DataGridView, ByVal bn As BindingNavigator)
        ...
        Dim qry As String = "select ProductID,ChequeNumber,ProductsCheques.CustomerID,CustomerName,Amount as TotalAmount,'' as Others,'' as Loan,'' as Quick,PayeeName,AccountNumber,Bank,BranchCode,PaymentDate,CapturedDate from ProductsCheques inner join CustomerDetails on ProductsCheques.CustomerID = CustomerDetails.CustomerID where PayBy = '" & PayBy & "' and ChequeNumber not in ('') and ProductsCheques.CustomerID = '" & customerid & "'"
        Dim ds As New DataSet
        Dim cmd As New SqlClient.SqlCommand(qry, con)
        Dim SQLAdapter As New System.Data.SqlClient.SqlDataAdapter(cmd)
        Dim dt As DataTable
    ...
    Private Sub loadChequesAllPerChequeNumber(ByVal ChequeNumber As String, ByVal Status As String, ByVal PayBy As String, ByVal dgv As DataGridView, ByVal bn As BindingNavigator)
        ...
        Dim qry As String = "select ProductID,ChequeNumber,ProductsCheques.CustomerID,CustomerName,Amount as TotalAmount,'' as Others,'' as Loan,'' as Quick,PayeeName,AccountNumber,Bank,BranchCode,PaymentDate,CapturedDate from ProductsCheques inner join CustomerDetails on ProductsCheques.CustomerID = CustomerDetails.CustomerID where PayBy = '" & PayBy & "' and ChequeNumber not in ('') and ChequeNumber = '" & ChequeNumber & "'"
        Dim ds As New DataSet
        Dim cmd As New SqlClient.SqlCommand(qry, con)
        Dim SQLAdapter As New System.Data.SqlClient.SqlDataAdapter(cmd)
        Dim dt As DataTable
    ...
    Private Sub tbpayby_TextChanged(sender As Object, e As EventArgs) Handles tbpayby.TextChanged
        Label7.Text = tbpayby.Text
    End Sub

    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        If DataGridView1.Rows.Count > 0 Then
            Label6.Text = "Value = " + getCurrency(Decimal.Parse(DataGridView1.CurrentRow.Cells(4).Value))
        End If
    End Sub
End Class