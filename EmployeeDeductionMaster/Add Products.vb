...
Public Class Add_Products
    ...
    Private Sub loadList(ByVal Status As String)
        DataGridView1.DataSource = Nothing

        Dim qry As String = "select * from Products where Status = '" & Status & "' order by AllocationOrder ASC"
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If decision("Are you sure to continue ?") = DialogResult.Yes Then
            If tbproductid.Text = "" Then
                If tbproductname.Text = "" Or tbproductallocationorder.Text = "" Or tbstatus.Text.Trim = "" Or tbautocalculate.Text.Trim = "" Or tbhassystem.Text.Trim = "" Or tbsystem.Text.Trim = "" Or tbuseincheques.Text.Trim = "" Or tbuseinsettlement.Text.Trim = "" Or tbuseinreceipts.Text.Trim = "" Or tbsalesproduct.Text.Trim = "" Then
                    MessageBox.Show("Enter all the details", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Else
                    saveProduct(tbproductname.Text.Trim, Integer.Parse(tbproductallocationorder.Text), tbstatus.Text.Trim, Integer.Parse(tbautocalculate.Text.Trim), Integer.Parse(tbhassystem.Text.Trim), tbsystem.Text.Trim, tbuseincheques.Text.Trim, tbuseinsettlement.Text.Trim, tbuseinreceipts.Text.Trim, tbsalesproduct.Text.Trim)
    ...
    Private Sub DataGridView1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.Click
        Try
            If DataGridView1.Rows.Count > 0 Then
                ...
                tbsalesproduct.Text = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(10).Value.ToString
                cbsalesproduct.SelectedIndex = cbsalesproduct.FindStringExact(tbsalesproduct.Text)
    ...
    Private Sub cbsalesproduct_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbsalesproduct.SelectedIndexChanged
        tbsalesproduct.Text = cbsalesproduct.Text
    End Sub
