...
Public Class AgentsList
    ...
    Public sc As SalesCustomers
    Public autoid As String

    Private Sub loadSalesAgents()
        DataGridView1.DataSource = Nothing
        Dim qry As String = "select * from SalesAgents Order By IDNumber ASC"
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        If DataGridView1.Rows.Count > 0 Then
            If whichform = "Customers" Then
                sc.tbagentid.Text = DataGridView1.CurrentRow.Cells(1).Value
                Close()
            End If
        End If
    End Sub

    Private Sub AgentsList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadSalesAgents()
    End Sub
End Class