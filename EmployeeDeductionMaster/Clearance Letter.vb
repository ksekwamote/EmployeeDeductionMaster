...
Public Class Clearance_Letter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EmployeeDeductionMaster.Clearance Letter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClearance_Letter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Clearance_Letter = New Clearance_Letter()
        rpt.Site = Me.Site
        Return rpt
    End Function
