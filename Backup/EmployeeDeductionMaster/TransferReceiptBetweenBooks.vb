...
Public Class TransferReceiptBetweenBooks
    ...
    Private Sub loadReceipts(ByVal PayerID As String, ByVal howmany As String)
        ...
        Dim qry As String = ""
        If howmany = "All" Then
            qry = "select PayerID,Amount,TransactionDate,ModeName,CapturedBy,CapturedTime,BatchName,Receipts.Status,CompanyName,Receipts.BookID,AutoID from Receipts inner join ModeOfPayment on Receipts.ModeID = ModeOfPayment.ModeID inner join CompanyBooks on Receipts.BookID = CompanyBooks.BookID"
        Else
            qry = "select PayerID,Amount,TransactionDate,ModeName,CapturedBy,CapturedTime,BatchName,Receipts.Status,CompanyName,Receipts.BookID,AutoID from Receipts inner join ModeOfPayment on Receipts.ModeID = ModeOfPayment.ModeID inner join CompanyBooks on Receipts.BookID = CompanyBooks.BookID where PayerID = '" & PayerID & "'"
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        If tbcompanybookidto.Text.Trim = "" Then
        ...
        Else
            ...
            Else
                If decision("Are you sure to transfer the receipt ?") = DialogResult.Yes Then
                    updateReceiptCompanyBookID(Integer.Parse(tbcompanybookidto.Text.Trim), Integer.Parse(tbreceiptid.Text.Trim))
                    updateReceiptBreakdownCompanyBookID(Integer.Parse(tbcompanybookidto.Text.Trim), batchname)
                    Close()
                End If
            End If
        End If
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        tbcompanynameto.Text = ""
        tbcompanybookidto.Text = ""

        Dim vrl As New BooksForTransfer
        vrl.MdiParent = mform
        vrl.trbb = Me
        vrl.Show()
    End Sub

    Private Sub TransferReceiptBetweenBooks_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
