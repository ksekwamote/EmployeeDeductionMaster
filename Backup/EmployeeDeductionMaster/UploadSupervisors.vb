...
Public Class UploadSupervisors
        ...
        If decision("Are you sure you want to proceed?") = DialogResult.Yes Then
            If DataGridView1.Rows.Count > 0 Then
                For Each row As DataGridViewRow In DataGridView1.Rows
                    saveSuperviors(row.Cells(0).Value.ToString, row.Cells(1).Value.ToString, row.Cells(2).Value.ToString, row.Cells(3).Value.ToString)
                Next
    ...
    Private Sub UploadSupervisors_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
