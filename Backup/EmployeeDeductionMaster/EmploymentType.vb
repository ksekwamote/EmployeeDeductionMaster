...
Public Class EmploymentType
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If tbemploymenttypeid.Text.Trim = "" Or tbemploymenttype.Text.Trim = "" Then
            ...
            Else
                If decision("Are you sure to proceed ?") = DialogResult.Yes Then
                    saveEmploymentType(tbemploymenttypeid.Text.Trim, tbemploymenttype.Text.Trim, "Active")
                    loadEmploymentType()
                    clearText()
                End If
            End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            If tbemploymenttypeid.Text = "" Or tbemploymenttype.Text.Trim = "" Then
            ...
            Else
                If decision("Are you sure to proceed ?") = DialogResult.Yes Then
                    updateEmploymentType(tbemploymenttypeid.Text.Trim, tbemploymenttype.Text.Trim)
                    loadEmploymentType()
                    clearText()
                End If
            End If
    ...
    Public Sub saveEmploymentType(ByVal EmploymentTypeID As String, ByVal EmploymentTypeName As String, ByVal Status As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try
            Dim qryinsert As String = "Insert into EmploymentType values ('" & EmploymentTypeID & "','" & EmploymentTypeName & "','" & Status & "')"
    ...
    Public Sub updateEmploymentType(ByVal EmploymentTypeID As String, ByVal EmploymentTypeName As String)
        Dim transactioninsert As SqlClient.SqlTransaction
        Try

            Dim qryinsert As String = "update EmploymentType set EmploymentTypeName = '" & EmploymentTypeName & "' where EmploymentTypeID = '" & EmploymentTypeID & "'"
            Dim cmdinsert As New SqlClient.SqlCommand(qryinsert, con)
            If con.State = ConnectionState.Closed Then
                con.Open()
            End If
